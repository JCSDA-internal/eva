...
from eva.plotting.batch.base.diagnostics.map_filled_contour import MapFilledContour

# --------------------------------------------------------------------------------------------------


class EmcpyMapFilledContour(MapFilledContour):
    """
    EmcpyMapFilledContour class is a subclass of the MapFilledContour class, tailored for
    configuring and plotting contour map visualizations using the emcpy library.

    Attributes:
        Inherits attributes from the MapFilledContour class.

...
class MapFilledContour(ABC):
    ...
    def __init__(self, config, logger, dataobj):
        ...
        """
        Creates a filled contour map plot abstract class based on the provided configuration.
        ...
        Example:
            ...
            ::
                    ...
                    logger = Logger()
                    map_plot = MapFilledContour(config, logger, None)
        """
